...
int main() {
    ...
    if (pid < 0) {
        ...
        char *program = "./hello"; // Path to the "hello_world" program which is compiled already
        char *args[] = {program, NULL};  // Arguments array

        // Replace the child process with the new program (New programme will be executed now)
