...
public:
    ...
    int prim_mst(int src)
    {
        ...
        priority_queue<pii, vpii, greater<pii>> Q; /// Initialized a min priority queue

        // Another array for mst set
        ...
        while (!Q.empty())
        {
            ...
            // Other wise take the current edge
            ans += wt;
            vis[node] = 1;
